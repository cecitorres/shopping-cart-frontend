        ...
        <div className="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
          <div className="flex lg:flex-row flex-col justify-center" id="cart">
            <div className="lg:w-2/3 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto" id="scroll">
              ...
              <p className="lg:text-4xl mb-4 text-3xl font-black leading-10 text-gray-800 dark:text-white pt-3">Shopping Cart <span className="float-right text-lg">3 Items</span></p>
              {/* 1st item */}
              <div className="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                ...
                <div className="md:pl-3 md:w-10/12 2xl:w-3/4 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between w-full pt-1">
                    ...
                    <p className="text-base font-black leading-none text-gray-800 dark:text-white">$50.00</p>
                    <p className="text-base font-black leading-none text-gray-800 dark:text-white">$100.00</p>
                  </div>
              ...
              <div className="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                <div>
                  ...
                  <div className="flex items-center justify-between pt-16">
                    <p className="text-base leading-none text-gray-800 dark:text-white">Items 3</p>
                  ...
                  <div className="flex flex-col pt-5">
                    ...
                    <div class="">
                      <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white ">
                        <option selected>Choose a shipping option</option>
                  ...
                  <div className="flex flex-col pt-5">
                    ...
                    <div className="mb-3 relative text-gray-600">
                      <input type="search" name="search" placeholder="Enter your code" class="bg-white h-10 px-5 pr-10 text-sm focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" />
                    </div>
                ...
                <div>
                  ...
                  <button onclick="checkoutHandler1(true)" className="text-base leading-none w-full py-5 bg-purple-700 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white dark:hover:bg-gray-700">Checkout</button>
                </div>
              </div>
            </div>
          </div>
